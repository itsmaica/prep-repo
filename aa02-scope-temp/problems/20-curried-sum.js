...
function curriedSum(numArgs){
  ...
  //*  - Define an empty array, `numbers`.
  let numbers = []; // private state in the main func.

  // ! important edge case will not pass spec without this statement
  ...
  const _curriedSum = (num) => {
    ...
    if (numArgs === numbers.length){
      ...
      //* add of the numbers we've collected with each call
